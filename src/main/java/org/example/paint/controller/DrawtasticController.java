...
public class DrawtasticController {
  ...
  private void initBinds() {
    ...
    opacitySlider.visibleProperty().bindBidirectional(toolManager.opacitySliderProperty()); // changed this because wasnt visable .bind(toolManager.opacitySliderProperty()
    opacityLabel.visibleProperty().bindBidirectional(toolManager.opacityLabelProperty()); // same here
